...
class Problem1(unittest.TestCase):
    ...
    def test_constructor_media(self):
        self.assertEqual(type(self.m1inst.title), type(u"s"),
                         "Testing whether inst var is a"
                         "unicode string"
                         "(all web data is unicode, generally)")
        self.assertEqual(type(self.m1inst.author), type(u"s"),
                         "Testing whether inst var is a"
                         "unicode string (all web"
                         "data is unicode, generally)")
        self.assertEqual(type(self.m1inst.itunes_URL), type(u"s"),
                         "Testing whether inst var is a"
                         "unicode string (all web"
                         "data is unicode, generally)")
